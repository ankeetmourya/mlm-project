...
const IncomeCard = () => {
  return (
    <div className="flex flex-col md:flex-row md:space-x-4">
      <div className="bg-white dark:bg-zinc-800 p-4 rounded-lg shadow-md flex-1 relative mb-4 md:mb-0">
        <div className="flex justify-between items-center">
          <span className="text-zinc-500 dark:text-zinc-400">Admin Income</span>
          <div className="relative group">
            <svg
              className="w-4 h-4 text-zinc-400 dark:text-zinc-500 cursor-pointer"
              fill="currentColor"
              viewBox="0 0 20 20"
            >
